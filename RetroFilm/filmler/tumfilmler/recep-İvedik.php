          ...
          <div class="row row-30 flex-column-reverse flex-lg-row">
            <div class="col-lg-8">
              <article class="post-info inset-1">
                <h4 class="post-info-title">Recep İvedik</h4>
                <div class="post-info-meta bg-gray-100">
                  <ul class="post-info-meta-list">
                    <li><span class="icon mdi mdi-calendar-blank"></span><span class="small-text font-weight-sbold">2008-02-22</span></li>
                    <li><span class="icon mdi mdi-star-outline"></span><span class="small-text font-weight-sbold">IMDB: 4.9/10</span></li>
                  </ul>
                </div>
                <p>Recep İvedik, İstanbul'da yaşayan, sıradan bir adamdır. Kendine özgü mizahi ve bazen absürt tavırlarıyla dikkat çeker. Bir gün yaşadığı apartmanın çatısından düşen bir topu kurtarmak isterken kaza yapar ve mahallesindeki insanlardan dışlanır. Bu olayın ardından yaşadığı sıkıntılar ve çevresinden aldığı tepkiler üzerine, mahallesinden uzaklaşarak yeni bir başlangıç yapmaya karar verir.
...
Filmin temel hikayesi, Recep İvedik'in yaşadığı bu köy macerası üzerine kuruludur. Onun olaylara bakış açısı, mizahi yaklaşımı ve etrafındaki insanlarla ilişkileri, film boyunca izleyiciye eğlenceli anlar yaşatır.</p>
                <table class="post-info-table">
                  ...
                  <tr>
                    ...
                    <td>Şahan Gökbakar, Fatma Toptaş, Tuluğ Çizgen</td>
                  </tr>
                  <tr>
                    <td>Film Süresi</td>
                    <td>102 dakika</td>
                  ...
                  <tr>
                    <td>Fragman Linki</td>
                    <td>https://youtu.be/ite5gbn55TQ?si=6PhLQmQGfhYzPZ7d</td>
                  </tr>
                  <tr>
                    <td>İzleme Linki</td>
                    <td>https://jetfilmizle.de/recep-ivedik-1-izle-2008.html</td>
                  </tr>
                </table>
              </article>
            </div>
            <div class="col-lg-4 text-center text-lg-start">
              <div class="movie-page-image"><img src="../../uploads/../uploads/Recep İvedik.png" alt="" width="375" height="491">
              </div>
            </div>
          </div>
        </div>
