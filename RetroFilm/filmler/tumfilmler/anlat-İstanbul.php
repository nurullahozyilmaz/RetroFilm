          ...
          <div class="row row-30 flex-column-reverse flex-lg-row">
            <div class="col-lg-8">
              <article class="post-info inset-1">
                <h4 class="post-info-title">Anlat İstanbul</h4>
                <div class="post-info-meta bg-gray-100">
                  <ul class="post-info-meta-list">
                    <li><span class="icon mdi mdi-calendar-blank"></span><span class="small-text font-weight-sbold">2005-03-11</span></li>
                    <li><span class="icon mdi mdi-star-outline"></span><span class="small-text font-weight-sbold">IMDB: 7.3/10</span></li>
                  </ul>
                </div>
                <p>İstanbul'un büyülü ve karmaşık dünyasında beş ayrı hikaye, beş farklı yönetmenin gözünden seyirciye aktarılır. Kentin her bir köşesi, karakterlerin hayatlarını ve duygusal derinliklerini anlatan öykülerle doludur.
...
Başka Bir Gece:
Bir gece kulübü sahibi olan bir adam, müşterileriyle ilişkilerinde ve iş hayatında karşılaştığı zorluklarla mücadele ederken, hayatında bir dizi önemli karar almaktadır. Gece kulübü, onun için sadece bir iş yeri değil, aynı zamanda yaşamının bir parçasıdır.</p>
                <table class="post-info-table">
                  <tr>
                    <td>Yönetmenler</td>
                    <td>Ümit Ünal, Kudret Sabancı, Selim Demirdelen, Ömür Atay, Yücel Yolcu</td>
                  </tr>
                  <tr>
                    <td>Başrol Oyuncuları</td>
                    <td>Mehmet Günsür, Azra Akın, Nejat İşler, Güven Kıraç, İsmail Hacıoğlu, Nurgül Yeşilçay</td>
                  </tr>
                  <tr>
                    <td>Film Süresi</td>
                    <td>95 dakika</td>
                  ...
                  <tr>
                    <td>Fragman Linki</td>
                    <td>https://youtu.be/JsrNUHWhJ4g?si=TXNRlHJBp8Va2GYG</td>
                  </tr>
                  <tr>
                    <td>İzleme Linki</td>
                    <td>https://www.google.com/search?q=anlat+istanbul+2005+izle&oq=anlat+istanbul+2005+izle&gs_lcrp=EgZjaHJvbWUyCQgAEEUYORiABDIKCAEQABiABBiiBDIKCAIQABiABBiiBDIKCAMQABiABBiiBNIBCDU2NDRqMGo3qAIAsAIA&sourceid=chrome&ie=UTF-8#fpstate=ive&vld=cid:3a4c0208,vid:PRXqfcTklJc,st:0</td>
                  </tr>
                </table>
              </article>
            </div>
            <div class="col-lg-4 text-center text-lg-start">
              <div class="movie-page-image"><img src="../../uploads/../uploads/Anlat İstanbul.png" alt="" width="375" height="491">
              </div>
            </div>
          </div>
        </div>
