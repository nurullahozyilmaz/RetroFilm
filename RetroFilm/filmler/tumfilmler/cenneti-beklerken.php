...
Kavganın ve aşkın imparatorluğunda hayatta kalma savaşı veren Eflatun ve Leyla, hayalle gerçeğin harmanlandığı bu büyülü masalda kendi cennetlerini yaratırlar.</p>
                <table class="post-info-table">
                  ...
                  <tr>
                    ...
                    <td>Altan Erkekli, Ahmet Mümtaz Taylan, Melisa Sözen, Derviş Zaim, Serhat Tutumluer, Mesut Akusta</td>
                  </tr>
                  <tr>
                    <td>Film Süresi</td>
                    <td>107 dakika</td>
                  ...
                  <tr>
                    <td>Fragman Linki</td>
                    <td>https://youtu.be/4oMhByyt7PU?si=6vL9Awb-iZoJdkqM</td>
                  </tr>
                  <tr>
                    <td>İzleme Linki</td>
                    <td>https://jetfilmizle.de/cenneti-beklerken-filmi-izle.html</td>
                  </tr>
                </table>
              </article>
            </div>
            <div class="col-lg-4 text-center text-lg-start">
              <div class="movie-page-image"><img src="../../uploads/../uploads/Cenneti Beklerken.png" alt="" width="375" height="491">
              </div>
            </div>
          </div>
        </div>
